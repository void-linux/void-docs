...
filesystem mounted at `/boot/efi`. As this is where the bootloader is stored, you will 
need to choose its size accordingly. A reasonable size for this partition could be
